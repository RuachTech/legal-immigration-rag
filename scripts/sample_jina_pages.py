...
async def sample_pages():
    ...
    for sample in sample_urls:
        ...
        try:
            ...
            print("Fetching content from Jina Reader...")
            ...
            print("Expected structure patterns:")
            print("  - Look for section IDs like 'SW 1.1', 'PT 2.3', etc.")
            print("  - Hierarchical headings with markdown (# , ## , ### )")
            print("  - Parent-child section relationships")
