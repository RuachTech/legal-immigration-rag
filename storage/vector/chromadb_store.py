    ...
    def hybrid_search(
        ...
        for i, chunk_id in enumerate(ids_list):
            ...
            chunk_metadata = ChunkMetadata(
                ...
                parent_section=str(metadata_dict.get("parent_section")) if metadata_dict.get("parent_section") else None,
                 hierarchy_level=int(metadata_dict.get("hierarchy_level", 0)) if isinstance(metadata_dict.get("hierarchy_level"), (int, float, str)) else 0  # type: ignore[arg-type]
            )
