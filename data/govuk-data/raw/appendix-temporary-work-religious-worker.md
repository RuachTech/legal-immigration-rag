---
url: https://www.gov.uk/guidance/immigration-rules/immigration-rules-appendix-temporary-work-religious-worker
part_name: Immigration Rules Appendix Temporary Work – Religious Worker
scraped_at: 2025-12-06T17:29:27.307150
---

Title: Immigration Rules - Immigration Rules Appendix Temporary Work – Religious Worker - Guidance

URL Source: https://www.gov.uk/guidance/immigration-rules/immigration-rules-appendix-temporary-work-religious-worker

Markdown Content:
Immigration Rules - Immigration Rules Appendix Temporary Work – Religious Worker - Guidance - GOV.UK 
...
[Skip to main content](https://www.gov.uk/guidance/immigration-rules/immigration-rules-appendix-temporary-work-religious-worker#content)
...
Validity requirements for a Religious Worker, Show
--------------------------------------------------
...
Suitability requirements for a Religious Worker, Show
-----------------------------------------------------

RW 2.1. The applicant must not fall for refusal under Part Suitability.
...
Eligibility requirements for a Religious Worker, Show
-----------------------------------------------------
...
Decision on an application as a Religious Worker, Show
------------------------------------------------------
...
### Period of grant for a Religious Worker
...
### Conditions of grant for a Religious Worker

1.   RW 8.3. The grant will be subject to all the following conditions: 
...
Dependants of a Religious Worker, Show
--------------------------------------
...
| Applicants inside the UK | If the dependant is applying at the same time as the Religious Worker, they can be included in the form Temporary Worker where the form allows dependants to be added. Otherwise: - Dependant partner - Dependant child |
...
RW 9.4. If applying for permission to stay, the applicant must be in the UK on the date of application.

1.   RW 9.4ZA. If applying for permission to stay, the applicant must not have, or have last been granted, permission: 
    1.   (a) as a Visitor; or
...
RW 10.1. The applicant must not fall for refusal under Part Suitability.
...
2.   RW 12.2. The requirements of Appendix Relationship with Partner must be met.
...
### Decision on an application as a dependent partner or dependent child of a Religious Worker
...
### Period of grant for a dependent partner or dependent child of a Religious Worker
...
### Conditions of grant for a dependent partner or dependent child of a Religious Worker
...
To help us improve GOV.UK, we’d like to know more about your visit today. [Please fill in this survey (opens in a new tab)](https://www.smartsurvey.co.uk/s/gov-uk-banner/?c=/guidance/immigration-rules/immigration-rules-appendix-temporary-work-religious-worker).
